          ...
          <section>
            <div class="news-content">
              <div class="news-image">
                <img src="{{ (!empty($news->image)) ? url('upload/admin_images/'.$news->image) : url('upload/no_image.jpg') }}" alt="{{ $news->title }}">
              </div>
              <div class="news-details">
                <div class="news-title">
                  {{ $news->title }}
                </div>
                <div class="news-time">{{ $news->created_at->format('F d, Y') }}</div>
